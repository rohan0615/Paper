...
def net(x,y_,qp,isdrop,global_step,learning_rate_init,momentum,decay_step, decay_rate):
    ...
    # test start --------
    # normalize first
    normalized_x_images_L = zero_mean_norm_local(x_image, 64, 64) # normalized
    h_image_L = aver_pool(normalized_x_images_L, 4) #down sampling
    # test end ----------
    ...
    # test start --------
    # normalize first
    normalized_x_images_M = zero_mean_norm_local(x_image, 64, 32)
    h_image_M = aver_pool(normalized_x_images_M, 2)
    # test end ----------
    ...
    # test start --------
    # normalize first
    normalized_x_images_S = zero_mean_norm_local(x_image, 64, 16)
    # test end ----------
    # h_conv1_S = non_overlap_conv(h_image_S, 4, NUM_CHANNELS, NUM_CONVLAYER1_FILTERS, acti_mode = acti_mode_conv)
    h_conv1_S = non_overlap_conv(normalized_x_images_S, 4, NUM_CHANNELS, NUM_CONVLAYER1_FILTERS, acti_mode = acti_mode_conv)
